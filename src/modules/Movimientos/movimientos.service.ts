...
import { createMovimientoManualSchema, listMovimientosQuerySchema, type createMovimientoType, type listMovimientosQueryType } from "./movimientos.schema.js";
import { Prisma } from "@prisma/client";
import { AppError } from "../../middlewares/error.middleware.js";

export const movimientosService = {
    async createMovimientoManual(negocioId: string, dto: createMovimientoType) {
        // 1. Validar
        ...
        if (!producto) throw new AppError("El producto no existe o no pertenece a tu negocio.");
    ...
    async getMovimientos(negocioId: string, query: listMovimientosQueryType) {
