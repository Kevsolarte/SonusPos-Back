...
export const createDeudaSchema = z.object({
  ...
  (d) => d.proveedorId || d.descripcionAcreedor,
  { message: "Debe indicar un proveedor o el nombre del acreedor" }
);
...
export type UpdateDeudaDto  = z.infer<typeof updateDeudaSchema>;
