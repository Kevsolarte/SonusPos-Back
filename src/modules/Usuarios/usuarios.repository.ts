...
import { type CreateUserDto, type UpdateUserDto } from "./usuarios.schema.js";
...
export const usuariosRepository = {
  ...
  async create(negocioId: string, data: CreateUserDto & { passwordHash: string }) {
  ...
  async update(id: string, negocioId: string, data: UpdateUserDto & { passwordHash?: string }) {
